...
RegisterServerEvent('esx_atmholdup:toofar')
AddEventHandler('esx_atmholdup:toofar', function(robb)
    local source = source
    ...
    if(robbers[source])then
        TriggerClientEvent('esx_atmholdup:toofarlocal', source)
        robbers[source] = nil
    ...
    if Stores[robb] then
        ...
        if rob == false then
            ...
            if(cops >= Config.PoliceNumberRequired)then
                ...
                TriggerClientEvent('esx_atmholdup:starttimer', source)
